...
//   int? _selectedItemId; // To store the selected item ID for matches
...
//     Navigator.pushNamed(context, '/item-details', arguments: itemId);
//   }

//   void _navigateToMatches(BuildContext context, int? itemId) {
//     if (itemId == null) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Please select an item to view matches')),
//       );
//       return;
//     }
//     Navigator.push(
//       context,
//       MaterialPageRoute(
//         builder: (context) => MatchesScreen(itemId: itemId),
//       ),
//     );
//   }
...
//               } else if (index == 3) {
//                 _navigateToMatches(context, _selectedItemId);
//               }
//             },
...
//             itemId: _selectedItemId ?? 0); // Default to 0 if no item selected
//       default:
//         return _buildHomeContent();
//     }
//   }
...
//           onLongPress: () {
//             setState(() {
//               _selectedItemId = item.id; // Set the selected item ID
//             });
//             ScaffoldMessenger.of(context).showSnackBar(
//               SnackBar(
//                   content: Text('Selected "${item.itemName}" for matching')),
//             );
//           },
//           borderRadius: BorderRadius.circular(16),
//           child: Container(
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _navigateToMatches(BuildContext context, int? itemId) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MatchesScreen(itemId: itemId)),
    );
  }
  ...
  Widget _buildBody() {
    switch (_currentIndex) {
      ...
      case 1:
        return Center(child: Text('Add Item Placeholder'));
      case 2:
        return MyItemsScreen();
      case 3:
        return MatchesScreen(itemId: _selectedItemId ?? 0);
      default:
        return Container();
    }
  }
